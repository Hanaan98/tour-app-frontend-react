  ...
  return (
    <div className=" w-full px-16 md:px-0 flex items-center justify-center">
      <div className="bg-white border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
        <p className="text-6xl md:text-7xl lg:text-9xl font-bold tracking-wider text-secondary">
          404
        </p>
        ...
        <Link
          to="/"
          className="flex items-center space-x-2 bg-secondary hover:opacity-90 text-gray-100 px-4 py-2 mt-6 rounded transition duration-150"
          title="Return Home"
        >
          <svg
